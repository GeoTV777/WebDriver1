...
//       Кликаем картинку
//        WebElement elPicture = driver.findElement(By.xpath("/html/body/section[2]/div/ul[2]/li[7]/span/a/div[2]/h3"));
//        elPicture.click();
////        Проверяем открытие картинки в модальном окне
//        WebElement elModalPicture = driver.findElement(By.cssSelector(".pp_hoverContainer"));
