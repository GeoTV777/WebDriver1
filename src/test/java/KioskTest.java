...
//      Кликаем картинку КАРТИНКА НЕ ТА!!! ВЫБРАТЬ ДРУГОЙ ЛОКАТОР!!
        WebElement elPicture = driver.findElement(By.xpath("//div[@class='content-overlay']"));
        elPicture.click();
//      Проверяем открытие картинки в модальном окне
        WebElement elModalPicture = driver.findElement(By.xpath("//div[@class='pp_hoverContainer']"));
